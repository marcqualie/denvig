...
describe('runCommand', () => {
  ...
  it('should pass extra arguments to the script command', async () => {
    ...
    await runCommand.handler(mockProject, { action: 'build' }, {}, extraArgs)
  ...
  it('should work without extra arguments', async () => {
    ...
    await runCommand.handler(mockProject, { action: 'test' }, {})
  ...
  it('should pass boolean flags correctly', async () => {
    ...
    await runCommand.handler(mockProject, { action: 'lint' }, {}, extraArgs)
